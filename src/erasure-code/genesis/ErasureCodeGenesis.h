...
#ifndef CEPH_ERASURE_CODE_GENESIS_H
#define CEPH_ERASURE_CODE_GENESIS_H

#include "erasure-code/ErasureCode.h"

class ErasureCodeGenesis : public ceph::ErasureCode {
public:
  int k;
  ...
  explicit ErasureCodeGenesis(const char *_technique) :
    k(0),
    DEFAULT_K("2"),
    m(0),
    DEFAULT_M("1"),
...
class ErasureCodeJerasureReedSolomonVandermonde : public ErasureCodeGenesis {
public:
  int *matrix;

  ErasureCodeJerasureReedSolomonVandermonde() :
    ErasureCodeGenesis("reed_sol_van"),
    matrix(0)
  {
    DEFAULT_K = "7";
    DEFAULT_M = "3";
...
class ErasureCodeJerasureReedSolomonRAID6 : public ErasureCodeGenesis {
public:
  int *matrix;

  ErasureCodeJerasureReedSolomonRAID6() :
    ErasureCodeGenesis("reed_sol_r6_op"),
    matrix(0)
  {
    DEFAULT_K = "7";
    DEFAULT_M = "2";
...
class ErasureCodeJerasureCauchy : public ErasureCodeGenesis {
public:
  int *bitmatrix;
  int **schedule;
  int packetsize;
...
class ErasureCodeJerasureLiberation : public ErasureCodeGenesis {
public:
  int *bitmatrix;
  int **schedule;
  int packetsize;
...
#endif //CEPH_ERASURE_CODE_GENESIS_H
